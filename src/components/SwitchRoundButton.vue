...
<template>
  <div class="switchRoundButton">
    ...
    >
      <svg class="highlight" viewBox="0 0 124 124">
        <path
      ...
      <img class="countDown" :src="getIcon('count_down')">
    </button>
...
.switchRoundButton {
  ...
  button.enable {
    ...
    .countDown {
      filter: invert(51%) sepia(15%) saturate(1988%) hue-rotate(359deg) brightness(98%) contrast(88%);
    }
